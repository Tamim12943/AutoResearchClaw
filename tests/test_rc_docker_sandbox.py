...
def test_build_run_command_rocm_image_maps_devices(tmp_path: Path):
    cfg = DockerSandboxConfig(
        image="researchclaw/experiment:rocm",
        gpu_device_ids=(0, 1),
        network_policy="none",
    )
    sandbox = DockerSandbox(cfg, tmp_path / "work")
